...
ARG RUBYGEM_OPENVOX
ENV RUBYGEM_OPENVOX=${RUBYGEM_OPENVOX:-8.19.2}

ARG RUBYGEM_OPENFACT
ENV RUBYGEM_OPENFACT=${RUBYGEM_OPENFACT:-5.0.0.rc1}

ARG RUBYGEM_VOXPUPULI_TEST
ENV RUBYGEM_VOXPUPULI_TEST=${RUBYGEM_VOXPUPULI_TEST:-11.1.0}

ARG RUBYGEM_VOXPUPULI_ACCEPTANCE
ENV RUBYGEM_VOXPUPULI_ACCEPTANCE=${RUBYGEM_VOXPUPULI_ACCEPTANCE:-3.8.0}

ARG RUBYGEM_VOXPUPULI_RELEASE
ENV RUBYGEM_VOXPUPULI_RELEASE=${RUBYGEM_VOXPUPULI_RELEASE:-4.0.0}
...
ARG RUBYGEM_R10K
ENV RUBYGEM_R10K=${RUBYGEM_R10K:-5.0.1}

ARG RUBYGEM_RA10KE
ENV RUBYGEM_RA10KE=${RUBYGEM_RA10KE:-4.4.0}
