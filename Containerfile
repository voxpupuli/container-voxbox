...
ARG RUBYGEM_RUBOCOP_CAPYBARA
ARG RUBYGEM_RUBOCOP_FACTORY_BOT
ARG RUBYGEM_RUBOCOP_GITLAB_FORMATTER
ARG RUBYGEM_RUBOCOP_PERFORMANCE
ARG RUBYGEM_RUBOCOP_RSPEC_RAILS
ARG RUBYGEM_TOML
ARG RUBYGEM_TOML_RB
...
ENV RUBYGEM_BUNDLER=${RUBYGEM_BUNDLER:-4.0.20}
...
ENV RUBYGEM_OPENFACT=${RUBYGEM_OPENFACT:-5.7.1}
...
ENV RUBYGEM_PUPPET_METADATA=${RUBYGEM_PUPPET_METADATA:-6.3.0}
...
# renovate: depName=rubocop-capybara datasource=rubygems
ENV RUBYGEM_RUBOCOP_CAPYBARA=${RUBYGEM_RUBOCOP_CAPYBARA:-3.0.0}
# renovate: depName=rubocop-factory_bot datasource=rubygems
ENV RUBYGEM_RUBOCOP_FACTORY_BOT=${RUBYGEM_RUBOCOP_FACTORY_BOT:-2.28.0}
...
ENV RUBYGEM_TOML_RB=${RUBYGEM_TOML_RB:-4.2.1}
